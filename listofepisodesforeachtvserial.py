    ...
    for eachtvserial in testjson :
        ...
        with open(os.getcwd() + "/TVSerials/" + slugifiedname + ".json","w") as writefile :
            ...
            try:
                ...
                #listofpages = driver.find_elements_by_xpath("///html/body[@class='viewforum f140']/div[@id='wrapper']/div[@id='wrapcentre']/div[@class='box extra-content control-box top']/div[@class='boxbody clearfix']/div[@class='pull-left nowrap']/b[@class='pagination']//descendant::a")
